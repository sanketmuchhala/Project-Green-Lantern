...
export const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleKeyChange = (field: keyof ApiKeys, value: string) => {
    ...
    // Auto-correct common model name typos
    if (field === 'modelName') {
      if (value.toLowerCase().includes('deekseek')) {
        value = value.toLowerCase().replace('deekseek', 'deepseek');
        console.log('✓ Auto-corrected model name:', value);
      }
    }
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. gpt-4o-mini, claude-3-5-sonnet-20241022, deepseek-chat"
                ...
                <div className="text-xs mt-1" style={{ color: 'hsl(var(--muted-foreground))' }}>
                  <div>OpenAI: gpt-4o, gpt-4o-mini, gpt-3.5-turbo</div>
                  <div>Anthropic: claude-3-5-sonnet-20241022, claude-3-5-haiku-20241022</div>
                  <div>DeepSeek: deepseek-chat, deepseek-coder</div>
                </div>
              </div>
